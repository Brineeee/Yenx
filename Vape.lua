...
function lib:Window(text, preset, closebind)
    ...
    Title1.Position = UDim2.new(0.9539285731, 0, 0.0564263314, 0)
    Title1.Size = UDim2.new(0, 200, 0, 23)
    Title1.Font = Enum.Font.GothamSemibold
    Title1.Text = "X"
    Title1.TextColor3 = Color3.fromRGB(255, 0, 0)
    Title1.TextSize = 14.000
    Title1.TextXAlignment = Enum.TextXAlignment.Left
        Title1.MouseButton1Click:Connect(
            function()
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            function tabcontent:Seperator(text)
                ...
                Seperator.Size = UDim2.new(0, 363, 0, 32)
    
                Sep1.Name = "Sep1"
                Sep1.Parent = Seperator
                Sep1.BackgroundColor3 = PresetColor
                ...
                SepLabel.Size = UDim2.new(0, 180, 0, 20)
                ...
                Sep2.BackgroundColor3 = PresetColor
                Sep2.BorderSizePixel = 0
                Sep2.Position = UDim2.new(0, 220, 0, 10)
            ...
            function tabcontent:Line()
                ...
                Line.Size = UDim2.new(0, 363, 0, 20)
    
                Linee.Name = "Linee"
                Linee.Parent = Line
                Linee.BackgroundColor3 = PresetColor
                Linee.BorderSizePixel = 0
                Linee.Position = UDim2.new(0, 0, 0, 10)
                Linee.Size = UDim2.new(0, 455, 0, 1)
            end

            function tabcontent:newDropdown(text,table,callback)
                local Dropdown = Instance.new("Frame")
                ...
                Dropdown.BackgroundColor3 = Color3.fromRGB(34, 34, 34)
                Dropdown.ClipsDescendants = true
                Dropdown.Size = UDim2.new(0, 363, 0, 30)
                ...
                for i,v in next,table do
                    ...
                    DropButton2.Size = UDim2.new(0, 355, 0, 30)
            ...
            function tabcontent:newToggle(text,config,callback)
                ...
                ToggleImage.Position = UDim2.new(0, 335, 0, 5)
                ...
                ToggleImage2.BackgroundColor3 = PresetColor
